...
public class PageUtil {
	...
	public PageUtil(int everyPage, int totalCount, int totalPage, int currentPage, int beginIndex, boolean hasPrePage,
	...
	public PageUtil(int everyPage, int totalCount, int currentPage) {// 创建分页信息对象
